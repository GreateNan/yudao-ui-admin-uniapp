<template>
  ...
  >
    <view class="p-32rpx">
      ...
      <view class="mb-24rpx">
        <view class="mb-12rpx text-28rpx text-[#666]"> 文件名称 </view>
        <wd-input
      ...
      <!-- <view class="mb-24rpx">
        <view class="mb-12rpx text-28rpx text-[#666]"> 文件 </view>
        <formPicker
          ref="formPickerRef"
...
const formData = reactive({
  ...
  standardYwlx: undefined as string | undefined,
...
const placeholder = computed(() => {
  ...
  if (formData.formId !== undefined) {
    ...
    conditions.push(`文件:${nickname || formData.formId}`);
  }
  ...
  if (formData.name) {
    conditions.push(`文件名称:${formData.name}`);
  }
  if (formData.action) {
...
function handleReset() {
  ...
  formData.standardYwlx = undefined;
